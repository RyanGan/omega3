...
```{r n3 rbc tv, echo=F, message=F, warning=F, results='asis'}
...
for(i in 1:length(n3_vars)){
  ...
  lin_mod <- tidy(lm(as.formula(paste0(n3_vars[i], "~omega3_bi")), tv_base_df))  
...
knitr::kable(n3_lvl_base_df, caption = paste0("Supplemental Table:",
  "Levels of n-3 FA % in RBCs in n-3 FA supplement users vs non-users timevarying",
  " at base"))
